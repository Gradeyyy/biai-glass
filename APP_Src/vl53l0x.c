...
//    HAL_GPIO_WritePin(VL53L0X_SD_GPIO_Port, VL53L0X_SD_Pin, RESET);//失能VL53L0X
	VL53L0X_SD_WTICH_CTRL_OFF();
	HAL_Delay(30);
	VL53L0X_SD_WTICH_CTRL_ON();
//	HAL_GPIO_WritePin(VL53L0X_SD_GPIO_Port, VL53L0X_SD_Pin, SET);//使能VL53L0X,让传感器处于工作(I2C地址会恢复默认0X52)
	HAL_Delay(30);
	//dev->I2cDevAddr=0x52;
...
//	HAL_GPIO_WritePin(VL53L0X_SD_GPIO_Port, VL53L0X_SD_Pin, RESET);//失能VL53L0X
	VL53L0X_SD_WTICH_CTRL_OFF();
	HAL_Delay(30);
//	HAL_GPIO_WritePin(VL53L0X_SD_GPIO_Port, VL53L0X_SD_Pin, SET);//使能VL53L0X,让传感器处于工作
	VL53L0X_SD_WTICH_CTRL_ON();
	HAL_Delay(30);
