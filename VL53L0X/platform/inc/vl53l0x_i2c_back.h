...
/* 定义读写SCL和SDA的宏，已增加代码的可移植性和可阅读性 */
	...
	#define VL_I2C_SCL_1()  VL5310X_I2C3_SCL_GPIO_PORT->BSRR =  VL5310X_I2C3_SCL_PIN				/* SCL = 1 */
	#define VL_I2C_SCL_0()  VL5310X_I2C3_SCL_GPIO_PORT->BRR =  VL5310X_I2C3_SCL_PIN			/* SCL = 0 */
	
	#define VL_I2C_SDA_1()  VL5310X_I2C3_SDA_GPIO_PORT->BSRR =  VL5310X_I2C3_SDA_PIN			/* SDA = 1 */
	#define VL_I2C_SDA_0()  VL5310X_I2C3_SDA_GPIO_PORT->BRR =  VL5310X_I2C3_SDA_PIN				/* SDA = 0 */
	
	#define VL_I2C_SDA_READ()  ((VL5310X_I2C3_SDA_GPIO_PORT->IDR & VL5310X_I2C3_SDA_PIN) != 0)	/* 读SDA口线状态 */
#endif
...
#define VL5310X_I2C3_SDA_GPIO_PORT				GPIOB			/* GPIO端口 */
#define VL5310X_I2C3_SCL_GPIO_PORT				GPIOA			/* GPIO端口 */

//#define VL5310X_I2C_GPIO_CLK			 	RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define VL5310X_I2C3_SCL_PIN					GPIO_PIN_8	/* 连接到SCL时钟线的GPIO */
#define VL5310X_I2C3_SDA_PIN					GPIO_PIN_5		/* 连接到SDA数据线的GPIO */

///IIC操作函数
void VL53L0X_i2c_init(void); //iic初始化
