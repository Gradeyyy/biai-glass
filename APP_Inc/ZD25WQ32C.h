...
#define PORT_SPI_WP					GPIOA

#define PIN_SPI_CS                GPIO_PIN_2
#define PIN_SPI_SCK               GPIO_PIN_3
#define PIN_SPI_MISO              GPIO_PIN_0
#define PIN_SPI_MOSI              GPIO_PIN_1
#define PIN_SPI_WP	              GPIO_PIN_7



#define SPI_CS_ENABLE             HAL_GPIO_WritePin(PORT_SPI_CS, PIN_SPI_CS,GPIO_PIN_RESET)//(PORT_SPI_CS->BRR  = PIN_SPI_CS)
#define SPI_CS_DISABLE            HAL_GPIO_WritePin(PORT_SPI_CS, PIN_SPI_CS,GPIO_PIN_SET)//(PORT_SPI_CS->BSRR = PIN_SPI_CS)

#define SPI_SCK_LOW               HAL_GPIO_WritePin(PORT_SPI_SCK, PIN_SPI_SCK,GPIO_PIN_RESET)//(PORT_SPI_SCK->BRR  = PIN_SPI_SCK)
#define SPI_SCK_HIGH              HAL_GPIO_WritePin(PORT_SPI_SCK, PIN_SPI_SCK,GPIO_PIN_SET)//(PORT_SPI_SCK->BSRR = PIN_SPI_SCK)

#define SPI_MISO_READ             HAL_GPIO_ReadPin(PORT_SPI_MISO, PIN_SPI_MISO)//(PORT_SPI_MISO->IDR & PIN_SPI_MISO)

#define SPI_MOSI_LOW             HAL_GPIO_WritePin(PORT_SPI_MOSI, PIN_SPI_MOSI,GPIO_PIN_RESET)// (PORT_SPI_MOSI->BRR  = PIN_SPI_MOSI)
#define SPI_MOSI_HIGH           HAL_GPIO_WritePin(PORT_SPI_MOSI, PIN_SPI_MOSI,GPIO_PIN_SET) // (PORT_SPI_MOSI->BSRR = PIN_SPI_MOSI)

#define SPI_WP_LOW            HAL_GPIO_WritePin(PORT_SPI_WP, PIN_SPI_WP,GPIO_PIN_RESET)// (PORT_SPI_MOSI->BRR  = PIN_SPI_MOSI)
#define SPI_WP_HIGH           HAL_GPIO_WritePin(PORT_SPI_WP, PIN_SPI_WP,GPIO_PIN_SET) // (PORT_SPI_MOSI->BSRR = PIN_SPI_MOSI)
